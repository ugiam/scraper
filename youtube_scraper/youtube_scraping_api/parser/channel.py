...
from ..decorators import custom_property
from ..urls import *
...
class Channel:
    ...
    def subscriber_count(self):
        ...
        """
        try: 
            # subscriber_count = next(searchDict(self._header_data, "subscriberCountText"))["simpleText"].split()[0]
            subscriber_count = next(searchDict(self._header_data, "contentMetadataViewModel"))['metadataRows'][1]['metadataParts'][0]["text"]["content"].split(" subscribers")[0]
